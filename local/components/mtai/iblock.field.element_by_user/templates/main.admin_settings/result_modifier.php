...
if(isset($arResult['additionalParameters']['bVarsFromForm']) && $arResult['additionalParameters']['bVarsFromForm'])
{
    ...
    $userFieldCode = $GLOBALS[$arResult['additionalParameters']['NAME']]['USER_FIELD_CODE'] ?? '';
}
elseif(is_array($arResult['userField']))
{
    ...
    $userFieldCode = $arResult['userField']['SETTINGS']['USER_FIELD_CODE'] ?? '';
}
else
{
	$iblockId = '';
...
$arResult['userFieldCode'] = $userFieldCode;